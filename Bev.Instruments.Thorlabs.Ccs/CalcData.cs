...
namespace Bev.Instruments.Thorlabs.Ccs
{
    public class CalcData
    {
        ...
        public CalcData(SpectralData measuredSpectrum)
        {
            ...
            {
                dataPoints[i] = new CalcDataPoint(measuredSpectrum.Wavelengths[i], measuredSpectrum.AverageValues[i], measuredSpectrum.NoiseValues[i], measuredSpectrum.StdDevValues[i]);
            }
        }
        ...
        public CalcData(CalcData other)
        {
            ...
            {
                dataPoints[i] = new CalcDataPoint(other.Wavelengths[i], other.AverageValues[i], other.NoiseValues[i], other.StdDevValues[i]);
            }
        }
